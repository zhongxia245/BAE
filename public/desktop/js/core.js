...
Core.create = function(obj, opt) {
    ...
    if (typeof(obj) === 'string') {
        ...
        sc = getIndexOfArrayById(shortcut, sc);
        var options = {
            num: shortcut[sc][0],
            title: shortcut[sc][1],
            imgsrc: shortcut[sc][2],
...
var GetTaskSystem = function(obj) {
    if (!_cache.TaskSystem) {
        _cache.TaskSystem = $('<div class="popup-menu task-menu" style="z-index:99999;top:30px;display:none"><ul><li><a menu="close" href="javascript:;">用户登录</a></li><li><a menu="close" href="javascript:;">用户登录</a></li></ul></div>');
...
/*============add by hxd===============*/
// 根据ID或者在数组中的下标，不存在返回-1
var getIndexOfArrayById = function(arr, id) {
...
var setRightMenu = function(menu) {
    ...
    $("#task-bar").smartMenu(menu.icosmenudata, {
        name: "task_bar"
    });
}
